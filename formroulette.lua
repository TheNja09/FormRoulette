...
function Cheats()
	...
	if baseTimer == 1 and ReadByte(Save+0x3524) == 0 and ReadShort(Now+0) ~= 0x0E07 and ReadShort(Now+0) ~= 0x0507 and ReadShort(Now+8) ~= 0x45 and ReadShort(Now+0) ~= 0x0A and ReadShort(Now+0) ~= 0x1712 then
